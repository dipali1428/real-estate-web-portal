                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-blue-50 rounded-2xl p-4 border border-blue-100">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-semibold text-blue-800">Getting Started</h4>
                                        <p className="text-xs text-blue-600 mt-1">
                                            Start adding your investments to see portfolio insights, track performance, and get personalized recommendations.
                                        </p>
                                        <button className="mt-3 px-4 py-2 bg-white text-blue-600 rounded-lg text-xs font-medium hover:bg-blue-50 transition-colors">
