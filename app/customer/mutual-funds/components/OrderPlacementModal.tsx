                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className={`relative p-6 rounded-3xl border-2 transition-all text-left flex flex-col items-center justify-center gap-3 ${
                        investmentType === "LUMPSUM" ? "border-[#2076C7] bg-blue-50/50 shadow-inner" : "border-slate-100 hover:border-slate-200"
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`relative p-6 rounded-3xl border-2 transition-all text-left flex flex-col items-center justify-center gap-3 ${
                        investmentType === "SIP" ? "border-[#1CADA3] bg-teal-50/50 shadow-inner" : "border-slate-100 hover:border-slate-200"
                      }`}
                    >
                    ...
                    {[1000, 2000, 5000, 10000, 25000].map((val) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-xs font-black transition-all whitespace-nowrap ${
                          amount === val ? "bg-[#2076C7] text-white" : "bg-slate-100 text-slate-500 hover:bg-slate-200"
                        }`}
                      >
                        ₹{val.toLocaleString()}
                      </button>
                        ...
                        {FREQUENCIES.map((freq) => (
                          <button
                            ...
                            className={`p-4 rounded-2xl border-2 font-black text-xs transition-all ${
                              frequency === freq ? "border-[#1CADA3] bg-teal-50 text-[#1CADA3]" : "border-slate-100 text-slate-400"
                            }`}
                          >
                            {freq}
                          </button>
                      ...
                      <div className="grid grid-cols-7 gap-2">
                        {INSTALLMENT_DAYS.map((day) => (
                          <button
                            ...
                            className={`h-10 rounded-xl border flex items-center justify-center font-black text-xs transition-all ${
                              installmentDay === day ? "bg-[#1CADA3] border-[#1CADA3] text-white shadow-lg" : "border-slate-100 text-slate-400 hover:border-slate-300"
                            }`}
                          >
                            {day}
                          </button>
