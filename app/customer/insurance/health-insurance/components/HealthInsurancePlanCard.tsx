...
const HealthInsurancePlanCard: React.FC<PlanProps> = ({ name, price, features, isPopular, bestFor, sumInsured, cashlessHospitals, claimSettlementRatio, onApply }) => {
    return (
        <motion.div
            ...
            <div className={`flex flex-col h-full bg-white rounded-[1.5rem] border transition-all duration-300 ${isPopular ? 'border-blue-400 ring-[4px] ring-blue-50' : 'border-gray-100 shadow-[0_5px_20px_rgba(0,0,0,0.02)]'}`}>
                ...
                <div className="p-4 flex flex-col h-full">
                    <div className="mb-2 flex flex-col items-center text-center">
                        ...
                        <h3 className="text-base font-bold text-[#2076C7] uppercase leading-tight tracking-tight mb-2 h-8 flex items-center justify-center">
                            {name}
                        </h3>
                    </div>
