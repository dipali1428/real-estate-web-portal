            ...
            <div className="p-6 flex flex-col h-full">
                ...
                <div className="mt-auto flex flex-col items-start gap-3 pt-6 border-t border-gray-50">
                    <button
                        ...
                        className="w-full py-3.5 text-white rounded-lg font-bold tracking-widest text-[11px] shadow-lg hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3 uppercase cursor-pointer"
