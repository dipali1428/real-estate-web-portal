...
coupon: isBond
  ? String(productData?.coupon || item.coupon || 0).replace('%', '')
  : undefined,

yield: isBond
  ? String(productData?.yield_percentage || productData?.yield || item.yield_percentage || 0).replace('%', '')
  : undefined,
                ...
                {isRealEstateSelected ? (
                  ...
                  <>
                   <th className="px-6 py-4 text-center text-[11px] font-bold text-gray-400 uppercase">{selectedCategory === 'bonds' ? 'Min Invest' : 'Price'}</th>
                                <th className="px-6 py-4 text-center text-[11px] font-bold text-gray-400 uppercase">{selectedCategory === 'bonds' ? 'Coupon' : 'Min Lot'}</th>
                                <th className="px-6 py-4 text-center text-[11px] font-bold text-gray-400 uppercase">{selectedCategory === 'bonds' ? 'Yield' : 'Min Investment'}</th>

                          <th className="px-6 py-4 text-center text-[11px] font-bold text-gray-400 uppercase">{selectedCategory === 'mutual-funds' ? 'Risk' : selectedCategory === 'bonds' ? 'Rating' : 'Depository'}</th>
                  </>
                )}
                <th className="px-6 py-4 text-center text-[11px] font-bold text-gray-400 uppercase tracking-wider">
                  Action
