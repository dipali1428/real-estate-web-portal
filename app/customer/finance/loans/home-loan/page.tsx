    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <div className="bg-white/90 backdrop-blur-md border-b border-gray-200/50 py-4 px-4 sm:px-6 lg:px-8 relative z-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex bg-gray-100/80 p-1.5 rounded-2xl w-fit overflow-x-auto no-scrollbar">
            <button
              onClick={() => setActiveTab("explore")}
              className={`px-5 py-2.5 text-sm font-bold flex items-center gap-2 rounded-xl transition-all whitespace-nowrap ${
                activeTab === "explore"
      ...
      {/* Active View */}
      {activeTab === "explore" ? <ExploreHomeLoans /> : <MyHomeLoans />}
    </div>
  );
}
