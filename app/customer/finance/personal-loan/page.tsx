      ...
      <div className="max-w-[1440px] mx-auto px-6 py-10 leading-relaxed">
        ...
        <div className="max-w-7x mx-auto space-y-8">
          ...
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            className="bg-gradient-to-r from-[#2076C7] to-[#1CADA3] rounded-2xl p-5 md:p-6 text-white overflow-hidden relative shadow-lg"
          >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h3 className="text-lg md:text-xl font-black">
                    {preApprovedOffers.length} offers starting at <span className="text-white underline decoration-white/30 underline-offset-4">10.25% p.a.</span>
                  </h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-6 md:p-10">
            ...
            <BankGrid onPlansClick={handlePlansClick} />
          </div>
      ...
      <AnimatePresence>
        {selectedPlan && (
          <PlanDetailDrawer
            ...
            onApply={(bankName, planKey) => handleApply(bankName, planKey)}
          />
        )}
      </AnimatePresence>
