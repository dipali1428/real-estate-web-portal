...
export default function BusinessLoanDashboardPartners() {
    return (
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="text-left">
                    ...
                    <p className="text-xs text-slate-400 font-bold uppercase tracking-[0.1em] mt-1">
                        Select a partner to explore customized business credit solutions
                    </p>
                </div>
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                         ...
                         <div>
                            ...
                            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">Get customized solutions for large scale business expansion.</p>
                         </div>
                    </div>
