...
export default function BusinessLoanDashboard() {
  ...
  React.useEffect(() => {
    ...
    return () => setLoanModalOpen(false); // Cleanup on unmount
  ...
  return (
    <div className="flex-1 p-4 sm:p-6 bg-[#F8FAFC] min-h-screen font-sans">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
            ...
            <div className="flex flex-col items-center sm:items-start">
              ...
              <p className="text-sm text-slate-500 flex items-center justify-center sm:justify-start gap-2">
                ...
                Fuel your business growth with tailored solutions
              </p>
            </div>
          </div>
      ...
      {activeTab === "EXPLORE" && (
        <div className="flex flex-col md:flex-row items-center gap-4 mb-8">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              type="text"
              placeholder={activeTab === "EXPLORE" ? "Search partner banks..." : "Search your applications..."}
              value={searchQuery}
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {activeTab === "EXPLORE" ? (
            <ExploreOffers searchQuery={searchQuery} sortBy={sortBy} />
          ) : activeTab === "CALCULATOR" ? (
            <Calculator />
          ) : (
            <MyApplications searchQuery={searchQuery} />
          )}
        </motion.div>
      </AnimatePresence>
