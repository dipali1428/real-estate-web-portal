    ...
    <div className="w-full font-sans">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8 lg:pr-8 lg:border-r border-slate-100">
          <div className="mb-4">
            <div
              className="inline-flex items-center gap-2 px-4 py-2 mb-4 bg-slate-50 border rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm border-[#2076C7]/20 text-[#2076C7]"
            >
              <IconBuildingBank size={14} /> Business Finance Architect
            </div>
