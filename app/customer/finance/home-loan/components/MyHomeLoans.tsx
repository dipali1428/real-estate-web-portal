    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <p className="text-sm font-medium text-gray-500 mb-1">Avg. Tenure Applied</p>
          <p className="text-2xl font-bold text-purple-600">
            {applications.length ? Math.round(applications.reduce((acc, a) => acc + a.tenure, 0) / applications.length) : 0} Years
          </p>
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
              <tr>
                ...
                <th className="py-4 px-6 text-right text-xs font-bold text-gray-600 uppercase tracking-wider">Req. Rate</th>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-blue-100">
                              ...
                              <div className="text-[10px] text-gray-400 mt-1">
                                {app.status === 'APPROVED' ? 'Sanction complete' : 
                                 app.status === 'PENDING' ? 'Under verification' : 
