                                        ...
                                        <div className="p-5 flex-1 flex flex-col">
                                            ...
                                            <div className="mt-auto flex flex-col gap-3 border-t border-slate-100 pt-4">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button onClick={() => openApplyNow(property.title || 'Fractional Real Estate', isDashboard)} className="flex-1 py-2.5 text-xs font-black rounded-xl bg-gradient-to-r from-[#2076C7] to-[#1CADA3] text-white shadow-md hover:shadow-lg transition-all">Apply Now</button>
