          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-2 gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
              ...
              <div className="flex flex-col items-center w-full sm:w-auto">
                <button
                  onClick={() => window.location.href = '../dsamanagement'}
                  className="flex items-center gap-2 px-4 py-2 bg-[#2076C7] text-white rounded-lg text-sm font-semibold hover:bg-[#2076C7] transition-all shadow-md shadow-blue-100"
                >
