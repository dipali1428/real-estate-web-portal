...
export default function BusinessLoanHero({
    ...
    return (
        <section className="relative overflow-hidden font-sans bg-white pt-0">
            ...
            <div className="relative container mx-auto px-4 pt-8 pb-10 md:pt-12 md:pb-16 mb-0 z-10">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        {/* Heading */}
                        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 min-h-16 md:min-h-20 leading-tight" style={{
                            background: 'linear-gradient(to right, #2076C7, #1CADA3, #2076C7)',
                            WebkitBackgroundClip: 'text',
                            WebkitTextFillColor: 'transparent',
                            backgroundClip: 'text'
                        }}>
                            Empowering Business <br /> with Smart Financing
                        </h1>

                        {/* Description */}
                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-10 text-gray-700 leading-relaxed">
                        ...
                        {/* Stats - Refined & Balanced */}
                        <div className="mt-10 sm:mt-16 flex flex-wrap justify-center gap-6 sm:gap-10 md:gap-20 w-full max-w-4xl mx-auto">
                            <div className="flex flex-col items-center">
                                <div className="text-4xl md:text-4xl font-extrabold mb-1 tracking-tight bg-linear-to-r from-[#2076C7] to-[#1CADA3] bg-clip-text text-transparent">
                                    9.5%<span className="text-xl md:text-2xl font-bold align-top mt-1 inline-block text-[#2076C7]">*</span>
                                </div>
                            ...
                            <div className="flex flex-col items-center">
                                <div className="text-4xl md:text-4xl font-extrabold mb-1 tracking-tight bg-linear-to-r from-[#2076C7] to-[#1CADA3] bg-clip-text text-transparent">
                                    24 <span className="text-xl md:text-2xl font-bold text-[#2076C7]">Hrs</span>
                                </div>
                                <div className="text-[10px] md:text-xs font-bold text-gray-500 uppercase tracking-[0.3em]">
                                    Fast Approval
                                </div>
