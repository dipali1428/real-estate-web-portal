    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="text-center lg:text-left py-10 lg:py-20 mx-auto lg:mx-0 max-w-2xl">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight">
          <span className="text-[#2076C7]">Securing Lives,</span> <br />
          <span className="text-[#1CADA3]">Building Legacies.</span>
        </h1>
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-5 mb-14">
          <button
            onClick={() =>
              document.getElementById("calculator")?.scrollIntoView({ behavior: "smooth" })
            }
            className="px-8 md:px-10 py-4 bg-gradient-to-r from-[#2076C7] to-[#1CADA3] text-white rounded-full font-bold text-sm md:text-lg shadow-lg hover:scale-[1.02] transition-all"
          >
          ...
          <button
            ...
            className="px-8 md:px-10 py-4 bg-white text-gray-700 border border-gray-200 rounded-full font-bold text-sm md:text-lg shadow-sm hover:shadow-md transition-all"
          >
            How it Works
          </button>
        </div>
      ...
      <div className="flex justify-center lg:justify-end">
        <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-xl">
          <div className="rounded-[2rem] overflow-hidden border-8 border-white shadow-2xl">
            <img
              src="https://images.pexels.com/photos/4546132/pexels-photo-4546132.jpeg?auto=compress&cs=tinysrgb&w=1200"
