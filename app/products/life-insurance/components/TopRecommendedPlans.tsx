...
export default function TopRecommendedPlans() {
    ...
    return (
        <>
            ...
            />
            <section
  className="py-20 md:py-28 bg-neutral-50 relative overflow-hidden text-gray-700 font-sans"
...
>
  ...
  <div className="container-custom relative z-10 px-6 md:px-10 mx-auto max-w-7xl">
    ...
    <div className="flex flex-col xl:flex-row items-center gap-6 mb-12">
      ...
      <div className="flex items-center gap-3 bg-white border border-slate-200 rounded-2xl px-5 py-3 w-full xl:w-[400px] shadow-sm">
        ...
        <input
          ...
          className="flex-1 bg-transparent text-sm font-semibold text-[#2076C7] placeholder:text-slate-500 outline-none"
        />
      </div>
      ...
      <div className="flex items-center gap-2 overflow-x-auto w-full xl:flex-1 justify-center xl:justify-start">
        {FILTER_TABS.map(tab => (
          <button
            ...
            className={`whitespace-nowrap px-4 py-2 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all border ${
              activeFilter === tab
              ...
              >
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-wider text-white shadow-md hover:scale-105 transition-all"
    ...
    {/* Disclaimer */}
    <p className="mt-16 text-center text-sm text-slate-400 max-w-2xl mx-auto leading-relaxed italic">
