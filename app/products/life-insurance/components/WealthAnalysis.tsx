...
const WealthAnalysis = () => {
    ...
    return (
        <section
  className="py-20 md:py-28 bg-neutral-100 relative overflow-hidden text-gray-700 font-sans"
  id="analysis"
>
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-16">
      ...
      <div className="w-full lg:w-5/12 space-y-8 text-center lg:text-left mx-auto lg:mx-0">
        ...
        <div>
          ...
          <p className="text-gray-500 text-lg md:text-xl font-light leading-relaxed max-w-xl mx-auto lg:mx-0">
        ...
        <div className="flex p-1.5 bg-white rounded-full border border-gray-100 max-w-sm mx-auto lg:mx-0 shadow-sm">
          <button
            ...
            className={`flex-1 py-3 px-4 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all ${
              activeTab === "cost"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium leading-relaxed">
                    ...
                    <span className="text-[#1CADA3] font-black">2.1x</span>.
                  </p>
                </div>
              </motion.div>
            )}
