...
export default function TrustSection() {
    ...
    return (
       <section
  className="py-16 md:py-24 bg-white text-[#2076C7] overflow-hidden relative font-sans"
  id="trust"
>
  {/* Ambient Glow */}
      ...
      >
        ...
        <div className="space-y-5 max-w-md mx-auto lg:mx-0">
          {[
            ...
            <div
              key={item}
              className="flex items-center justify-center lg:justify-start gap-4 text-base md:text-lg group"
            >
