...
export default function CardTypesSection({
    ...
    return (
        <section className={isDashboard ? '' : `bg-white rounded-tl-[2rem] rounded-tr-[2rem] md:rounded-none ${topContent ? 'py-16 lg:py-24 pt-8 lg:pt-12' : 'py-16 lg:py-24'}`}>
            <div className={isDashboard ? '' : `max-w-[1440px] mx-auto px-6`}>
                                    ...
                                    <p className="text-xs text-slate-500 font-medium flex items-center justify-center sm:justify-start gap-2">
                                        <span>
                                            {activeTab === 'cards'
                                                ...
                                                : 'View your card details and recent transactions'}
                                        </span>
                                    </p>
                                </div>
                            </div>
                                                            ...
                                                            <div className="flex-grow space-y-4">
                                                                ...
                                                                <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm py-2">
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <span className="text-slate-600 font-medium text-xs">Joining Fee: <strong className="text-[#2076C7] font-black">{card.joiningFee}</strong></span>
                                                                    </div>
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <span className="text-slate-600 font-medium text-xs">Annual/Renewal Fee: <strong className="text-[#2076C7] font-black">{card.annualFee}</strong></span>
                                                                    </div>
                                                                </div>
