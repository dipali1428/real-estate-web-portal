...
export default function SingularityFoFDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);

    // Allocation by Fund Type Data
    const fundTypeData = {
        labels: ['Venture Capital Funds', 'Growth Equity Funds', 'Thematic / Sector Funds'],
        datasets: [
            {
                data: [50, 30, 20],
    ...
    // Investment Layer Data
    const investmentLayerData = {
        labels: ['Fund Investments', 'Direct Co-investments', 'Cash / Liquid'],
        datasets: [
            {
                label: 'Allocation %',
                data: [80, 10, 10],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            A specialized Fund of Funds (FoF) AIF providing diversified exposure to multiple top-performing venture and growth funds across innovation-led sectors.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Tenure", value: "5–7 Years", icon: Clock },
                        { label: "Theme", value: "FoF / Venture", icon: TrendingUp },
                        { label: "Return Type", value: "Capital Appr.", icon: Target }
                    ].map((item, i) => (
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Singularity Fund of Funds II follows a multi-manager strategy, providing diversified exposure to top-tier venture and growth equity funds. The strategy focuses on innovation-led businesses and technology-driven sectors, aiming to generate long-term capital appreciation through expert fund selection and active portfolio construction.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <PieChartIcon className="w-5 h-5 text-[#1CADA3]" /> Allocation by Fund Type
                                </h4>
                                <div className="h-[250px] relative mb-8">
                                    <Pie data={fundTypeData} options={pieOptions} />
                                ...
                                <div className="space-y-3">
                                    {fundTypeData.labels.map((label, i) => (
                                        <div key={i} className="flex justify-between items-center text-sm">
                                            <div className="flex items-center gap-2">
                                                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: fundTypeData.datasets[0].backgroundColor[i] }} />
                                                <span className="font-medium text-gray-600">{label}</span>
                                            </div>
                                            <span className="font-bold text-gray-900">{fundTypeData.datasets[0].data[i]}%</span>
                                        </div>
                                    ))}
                                </div>
                            </section>
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <BarChartIcon className="w-5 h-5 text-[#2076C7]" /> Investment Layer
                                </h4>
                                <div className="h-[250px] w-full">
                                    <Bar data={investmentLayerData} options={barOptions} />
                                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Singularity AMC LLP</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Expert fund selection
                                </li>
                                <li className="flex items-center gap-2:">
                                    <CheckCircle size={14} className="text-white/60" /> Specialized FoF platform
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Deep due diligence
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Long-term deployment
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Diversify into <br /> Venture Capital</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for investors seeking diversified exposure to top venture and growth funds.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Diversification", value: "Multi-Manager", icon: Activity },
                            { label: "VC Seekers", value: "VC Exposure", icon: TrendingUp },
                            { label: "Long-term", value: "Growth Horizon", icon: Clock }
                        ].map((item, i) => (
