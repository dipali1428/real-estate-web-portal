...
export default function BharatValueDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Industrials', 'Financial Services', 'Consumer', 'Technology', 'Others'],
        datasets: [
            {
                data: [30, 25, 20, 15, 10],
                backgroundColor: ['#2076C7', '#1CADA3', '#123E66', '#4FD1C5', '#CBD5E1'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
    ...
    const investmentStyleData = {
        labels: ['Value Inv.', 'Special Situations', 'Growth Opp.'],
        datasets: [
            {
                label: 'Allocation %',
                data: [60, 25, 15],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tighter font-sans leading-[1.1] bg-gradient-to-r from-[#2076C7] via-[#1CADA3] to-[#2076C7] bg-clip-text text-transparent drop-shadow-sm">
                            Bharat Value Fund <br />
                            (Series IV)
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            A value-oriented private equity AIF focused on identifying undervalued businesses and special situations with strong growth potential.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Value PE", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Bharat Value Fund – Series IV follows a value + opportunistic private equity strategy. The fund aims to generate long-term capital appreciation by identifying undervalued mid-market companies and special situation opportunities across sectors, leveraging deep valuation analysis and active value-unlocking strategies.
                            </p>
                            <div className="grid md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    "Mispriced asset identification",
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                ...
                                <div className="h-[250px] relative mb-8">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                        ...
                                        <span className="text-[10px] text-gray-400 font-bold uppercase">Portfolio</span>
                                    </div>
                                </div>
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <BarChartIcon className="w-5 h-5 text-[#1CADA3]" /> Investment Style
                                </h4>
                                <div className="h-[250px] w-full">
                                    <Bar data={investmentStyleData} options={barOptions} />
                                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Wealth Company Asset Mgmt</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Value-oriented approach
                                </li>
                                <li className="flex items-center gap-2:">
                                    <CheckCircle size={14} className="text-white/60" /> Special situation mastery
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Deep valuation analysis
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Growth unlocking focus
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Value <br /> Discovery Beta</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for investors seeking high-conviction value and special situation returns.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Value Seekers", value: "Undervalued Focus", icon: Target },
                            { label: "Long-term", value: "Capital Growth", icon: Clock },
                            { label: "Opportunistic", value: "Special Situations", icon: Activity }
                        ].map((item, i) => (
