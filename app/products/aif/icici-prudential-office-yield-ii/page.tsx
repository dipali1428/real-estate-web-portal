...
export default function ICICIOfficeYieldDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const assetData = {
        labels: ['Office Assets', 'Commercial Real Estate', 'Others'],
        datasets: [
            {
                data: [70, 20, 10],
                backgroundColor: ['#1CADA3', '#2076C7', '#0E8A82'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
    ...
    const typeData = {
        labels: ['Lease-backed Debt', 'Structured Credit', 'Mezzanine'],
        datasets: [
            {
                label: 'Allocation %',
                data: [50, 30, 20],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Real estate-focused credit fund that targets stable income through Grade A commercial office assets and lease-backed structures.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Return Type", value: "Rental Yield", icon: Target }
                    ].map((item, i) => (
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                ICICI Prudential Office Yield Optimiser Fund – AIF II is a real estate-focused credit fund that targets stable income through Grade A commercial office assets and lease-backed structures. The focus is on stable rental yield and asset-backed security with strong tenant quality assessment.
                            </p>
                            <div className="grid md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    "Strong tenant quality assessment",
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                ...
                                <div className="h-[250px] relative mb-8">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                        ...
                                        <span className="text-[10px] text-gray-400 font-bold uppercase">RE Mix</span>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            "Focus on lease-backed debt and structured credit for stable yield generation."
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                "One of India’s leading AMCs with expertise in real estate investing and alternative strategies."
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Focus on leased office assets
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Strong tenant quality assessment
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Conservative LTV approach
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Active monitoring of cash flows
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Diversify With <br /> Commercial Real Estate</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for income-focused investors seeking real estate exposure with low volatility.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Income-focused", value: "Rental Yield", icon: IndianRupee },
                            { label: "RE Seekers", value: "Grade A Office", icon: Briefcase },
                            { label: "Low-volatility", value: "Stable Yield", icon: ShieldCheck }
                        ].map((item, i) => (
