...
export default function IrrisWhiteboardDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Credit-focused AIF designed to generate stable and predictable income through yield-oriented investments.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Yield / Credit", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Irris Whiteboard Yield Fund follows a yield / credit strategy, targeting secured lending and structured credit opportunities. The fund aims for consistent accrual-based returns with a strong focus on income generation and capital preservation through disciplined credit underwriting and risk-managed allocation.
                            </p>
                            <div className="grid md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    "Credit underwriting focus",
                                    "Accrual-based returns"
                                ].map((focus, i) => (
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            "A focus on secured debt instruments for consistent accrual income."
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Irris Whiteboard</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                "Focused on credit investments and yield-oriented strategies with structured finance expertise."
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Disciplined credit underwriting
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Diversified asset exposure
                                </li>
                                <li className="flex items-center gap-2">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Generate Stable <br /> Yield Returns</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for income-focused investors looking for fixed-income diversification.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Income-focused", value: "Predictable Yield", icon: IndianRupee },
                            { label: "Conservative", value: "Fixed Income", icon: ShieldCheck },
                            { label: "Diversification", value: "Credit Mix", icon: Briefcase }
                        ].map((item, i) => (
