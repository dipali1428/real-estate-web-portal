...
export default function InvictaContinuumDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Growth-focused private equity AIF aimed at investing in scalable Indian businesses across high-growth sectors.
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Invicta Continuum Fund I follows a growth / private equity strategy, partnering with companies in their growth and expansion phases. The fund seeks to deliver long-term capital appreciation by investing in scalable Indian businesses across consumer, technology, and financial services sectors with strong management teams.
                            </p>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Invicta Capserv</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Bottom-up company selection
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Sectoral research focus
                                </li>
                                <li className="flex items-center gap-2">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Partner with <br /> Scalable Businesses</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for growth-focused investors seeking mid-market PE exposure.</p>
                            <div className="space-y-3">
