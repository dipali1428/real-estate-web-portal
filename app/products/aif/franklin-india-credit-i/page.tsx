...
export default function FranklinIndiaCreditDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Corporate Credit', 'Financial Services / NBFC', 'Structured Credit', 'Others'],
        datasets: [
            {
                data: [45, 25, 20, 10],
    ...
    const instrumentData = {
        labels: ['Debt Instruments', 'Structured Credit', 'Cash / Liquid'],
        datasets: [
            {
                label: 'Allocation %',
                data: [60, 25, 15],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tighter font-sans leading-[1.1] bg-gradient-to-r from-[#2076C7] via-[#1CADA3] to-[#2076C7] bg-clip-text text-transparent drop-shadow-sm">
                            Franklin India Credit <br />
                            AIF – Scheme I
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Credit-focused AIF designed to generate stable income through diversified debt opportunities and high-quality credit instruments.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Credit / Fixed Income", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Franklin India Credit AIF – Scheme I follows a fixed income / credit strategy, aiming for consistent accrual-based returns through corporate credit instruments and structured lending. The fund focuses on income generation with capital preservation using deep credit research.
                            </p>
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                ...
                                <div className="h-[250px] relative mb-8">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                        ...
                                        <span className="text-[10px] text-gray-400 font-bold uppercase">Debt Mix</span>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            A diversified credit portfolio focusing on high-quality debt and structured opportunities.
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Franklin Templeton</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                A globally recognized asset manager with strong expertise in fixed income and credit risk analysis.
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Deep credit research
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Risk-adjusted allocation
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Institutional management
                                </li>
                                <li className="flex items-center gap-2">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Generate Stable <br /> Accrual Income</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for income-focused investors seeking fixed-income diversification.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Conservative", value: "Risk Aware", icon: ShieldCheck },
                            { label: "Diversification", value: "Fixed Income", icon: Briefcase }
                        ].map((item, i) => (
