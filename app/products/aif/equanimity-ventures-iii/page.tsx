...
export default function EquanimityVenturesDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Technology', 'Consumer / D2C', 'Fintech', 'Others'],
        datasets: [
            {
                data: [40, 25, 20, 15],
    ...
    const stageData = {
        labels: ['Early Stage', 'Growth Stage', 'Pre-IPO'],
        datasets: [
            {
                label: 'Allocation %',
                data: [50, 35, 15],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tighter font-sans leading-[1.1] bg-gradient-to-r from-[#2076C7] via-[#1CADA3] to-[#2076C7] bg-clip-text text-transparent drop-shadow-sm">
                            Equanimity Ventures <br />
                            Trust III
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Venture-focused Category II AIF that invests in high-growth, early-to-growth stage startups in India.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Venture / Growth", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Equanimity Ventures Trust III follows a venture / growth investing strategy, backing scalable businesses with strong growth potential across technology-driven and emerging sectors. The fund aims to generate long-term capital appreciation by identifying high-growth opportunities with scalable models.
                            </p>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-teal-50 rounded-2xl border border-teal-100">
                                        <p className="text-xs text-teal-800 font-medium italic">
                                            "Focus on high-growth early and growth stage companies with strong scalability."
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Equanimity Management Services</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                "A venture-focused investment platform known for startup investing expertise and a founder-centric approach."
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Founder evaluation
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Sector-focused research
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Scalable business models
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Active portfolio support
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Back the Next <br /> Tech Unicorn</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for long-term investors seeking high-risk, high-return venture opportunities.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Venture Seekers", value: "VC Exposure", icon: Target },
                            { label: "Long-term", value: "Patient Capital", icon: Clock },
                            { label: "Risk-takers", value: "High Growth", icon: TrendingUp }
                        ].map((item, i) => (
