...
export default function SteptradeChanakyaDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const investmentTypeData = {
        labels: ['Growth Equity', 'Opportunistic Deals', 'Pre-IPO'],
        datasets: [
            {
                label: 'Allocation %',
                data: [50, 30, 20],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tighter font-sans leading-[1.1] bg-gradient-to-r from-[#2076C7] via-[#1CADA3] to-[#2076C7] bg-clip-text text-transparent drop-shadow-sm">
                            Steptrade Chanakya <br />
                            Opportunities Fund II
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            An opportunistic growth AIF focused on identifying high-potential Indian companies and market inefficiencies to generate long-term capital appreciation.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Growth / Opp.", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Steptrade Chanakya Opportunities Fund II follows a growth + opportunistic investment strategy. The fund targets high-conviction ideas with strong upside potential across mid-market growth companies, special situation opportunities, and pre-IPO investments, leveraging market inefficiencies to deliver superior risk-adjusted returns.
                            </p>
                            <div className="grid md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    "Deep research-driven selection",
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Steptrade Capital</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Growth equity focused
                                </li>
                                <li className="flex items-center gap-2:">
                                    <CheckCircle size={14} className="text-white/60" /> Opportunistic strategies
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Market inefficiency capture
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Deep research selection
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Identify <br /> Growth Gems</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for investors seeking high-conviction growth and opportunistic returns.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Growth-focused", value: "Equity Seeking", icon: TrendingUp },
                            { label: "Opportunistic", value: "High Conviction", icon: Activity },
