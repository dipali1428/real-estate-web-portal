...
export default function BharathTransformationDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Industrials & Manufacturing', 'Financial Services', 'Infrastructure', 'Consumer', 'Others'],
        datasets: [
            {
                data: [30, 25, 20, 15, 10],
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Thematic / Growth", icon: TrendingUp },
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Bharath Transformation Fund – Fund I follows a thematic and growth strategy, focusing on capturing opportunities arising from India’s structural transformation. The fund aims to generate long-term capital appreciation by investing in sectors benefiting from India’s growth story and policy tailwinds, such as manufacturing, infrastructure, and financial services.
                            </p>
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Sincere Syndication</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Theme-based selection
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Macro + sector analysis
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Strong due diligence
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Long-term value creation
                                </li>
                            </ul>
                        </section>
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "India Growth", value: "Structural Gains", icon: Activity },
                            { label: "Thematic", value: "Sector Focused", icon: TrendingUp },
                            { label: "Wealth Creators", value: "Long-term Horizon", icon: Clock }
                        ].map((item, i) => (
