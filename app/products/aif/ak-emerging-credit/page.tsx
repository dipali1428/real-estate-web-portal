...
export default function AKEmergingCreditDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Corporate Credit', 'Special Situations', 'Structured Deals', 'Others'],
        datasets: [
            {
                data: [35, 25, 25, 15],
                backgroundColor: ['#1CADA3', '#2076C7', '#0E8A82', '#94A3B8'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
    ...
    const typeData = {
        labels: ['High-Yield Debt', 'Structured Credit', 'Distressed / Special'],
        datasets: [
            {
                label: 'Allocation %',
                data: [45, 30, 25],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Credit-focused AIF capturing high-yield opportunities across emerging credit markets.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Opportunistic Credit", icon: TrendingUp },
                        { label: "Return Type", value: "High Yield", icon: Target }
                    ].map((item, i) => (
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                A.K Emerging Credit Opportunities Fund III is designed to capture high-yield opportunities across emerging credit markets. The fund aims to generate superior risk-adjusted returns by investing in undervalued and special situation credit opportunities through an opportunistic credit strategy.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <PieChartIcon className="w-5 h-5 text-[#1CADA3]" /> Sector Allocation
                                </h4>
                                <div className="h-[250px] relative mb-8">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                        ...
                                        <span className="text-[10px] text-gray-400 font-bold uppercase">Exposure Mix</span>
                                    </div>
                                </div>
                                    ...
                                    {sectorData.labels.map((label, i) => (
                                        <div key={i} className="flex justify-between items-center text-sm">
                                            <div className="flex items-center gap-2">
                                                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: sectorData.datasets[0].backgroundColor[i] }} />
                                                <span className="font-medium text-gray-600">{label}</span>
                                            </div>
                                            <span className="font-bold text-gray-900">{sectorData.datasets[0].data[i]}%</span>
                                        </div>
                                    ))}
                                </div>
                            </section>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            Targeting high-yield debt and special situations for alpha generation.
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">A.K. Alt Asset Managers</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                Specialists in credit investing and special situations with over two decades of capital market expertise.
                            </p>
                            <div className="grid grid-cols-2 gap-2">
                                <div className="bg-white/10 p-2 rounded-lg text-[10px] font-bold text-center">Structured Finance</div>
                                <div className="bg-white/10 p-2 rounded-lg text-[10px] font-bold text-center">Credit Alpha</div>
                            </div>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">High-Yield <br /> Opportunities</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Capture superior risk-adjusted returns in emerging credit.</p>
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-3 text-[10px] font-black uppercase tracking-wider">
                                    <button className="py-3 bg-white/5 hover:bg-white/10 rounded-xl border border-white/10 transition-colors lowercase italic capitalize">Request PPM</button>
                                    <button className="py-3 bg-white/5 hover:bg-white/10 rounded-xl border border-white/10 transition-colors lowercase italic capitalize">Talk to Advisor</button>
                                </div>
                            </div>
                        </section>
                    </div>
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            { label: "HNIs / UHNIs", value: "Sophisticated", icon: Users },
                            { label: "Yield-seeking", icon: IndianRupee, value: "High Return" },
                            { label: "Risk-tolerant", icon: ShieldCheck, value: "Credit Alpha" },
                            { label: "Alt Credit", icon: TrendingUp, value: "Diversification" }
                        ].map((item, i) => (
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-amber-50/50 border border-amber-200/50 rounded-3xl p-8 flex items-start gap-4 shadow-sm italic">
                        ...
                        <p className="text-amber-900 text-sm font-medium leading-relaxed">
                            <strong>Mandatory Disclaimer:</strong> Investments in AIFs are subject to market risks. Category II AIFs are closed-ended and have liquidity constraints. Suitable for long-term investors only. Please read the PPM carefully before investing.
                        </p>
                    </div>
                </div>
            </div>
