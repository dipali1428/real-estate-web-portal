...
export default function Quest4ValueScaleDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        ...
        datasets: [
            {
                data: [30, 25, 20, 15, 10],
                backgroundColor: ['#1CADA3', '#2076C7', '#0E8A82', '#0C706A', '#94A3B8'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Growth-oriented AIF focused on investing in listed and pre-IPO companies with strong earnings growth potential and sustainable competitive advantages.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Quest4Value S.C.A.L.E. Fund II follows a growth equity and public market strategy. The fund aims to deliver long-term capital appreciation by identifying high-quality businesses with sustainable competitive advantages, focusing on listed small & mid-cap companies and selective pre-IPO opportunities with strong earnings visibility.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <BarChartIcon className="w-5 h-5 text-[#2076C7]" /> Market Cap Allocation
                                </h4>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                ...
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Strong research framework
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Focus on quality businesses
                                </li>
                                <li className="flex items-center gap-2">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Scale Your <br /> Equity Portfolio</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for long-term growth investors seeking high-quality small & mid-cap exposure.</p>
                            <div className="space-y-3">
