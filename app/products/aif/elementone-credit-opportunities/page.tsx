...
export default function ElementOneCreditDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);

    // Allocation by Strategy Data
    const strategyData = {
        labels: ['Structured Credit Funds', 'Performing Credit', 'Special Situations', 'Others'],
        datasets: [
            {
                data: [40, 30, 20, 10],
    ...
    const instrumentData = {
        labels: ['Fund of Funds (Credit)', 'Direct Credit Exposure', 'Cash / Liquid'],
        datasets: [
            {
                label: 'Allocation %',
                data: [70, 20, 10],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tighter font-sans leading-[1.1] bg-gradient-to-r from-[#1CADA3] via-[#2076C7] to-[#1CADA3] bg-clip-text text-transparent drop-shadow-sm">
                            ElementOne Credit <br />
                            Opportunities Fund
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Credit-focused Fund of Funds (FoF) designed to provide diversified exposure to top private credit opportunities.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Tenure", value: "3–6 Years", icon: Clock },
                        { label: "Theme", value: "Credit FoF", icon: TrendingUp },
                        { label: "Return Type", value: "Income + Accrual", icon: Target }
                    ].map((item, i) => (
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                ElementOne Credit Opportunities Fund follows a multi-manager private credit strategy, allocating across multiple institutional-grade credit funds to enhance diversification and reduce risk. Focus is on diversification, institutional access, and risk optimization.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <PieChartIcon className="w-5 h-5 text-[#1CADA3]" /> Allocation by Strategy
                                </h4>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">ElementOne Alternatives</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Manager selection & screening
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Multi-layer risk management
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Data-driven risk assessment
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Continuous monitoring
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Diversify Your <br /> Credit Portfolio</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for risk-conscious alternative investors seeking consistent returns.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "FOF Seekers", value: "Diversified Credit", icon: Briefcase },
                            { label: "Income-focused", value: "Regular Yield", icon: IndianRupee },
                            { label: "Risk-conscious", value: "Risk Optimized", icon: ShieldCheck }
                        ].map((item, i) => (
