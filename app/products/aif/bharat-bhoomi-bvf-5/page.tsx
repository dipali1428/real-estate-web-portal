...
export default function BharatBhoomiDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const assetData = {
        labels: ['Residential Projects', 'Commercial Real Estate', 'Land / Others'],
        datasets: [
            {
                data: [55, 25, 20],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            A real estate-focused AIF designed to generate long-term value through property and development opportunities across high-potential Indian projects.
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Bharat Bhoomi Fund (BVF–5) focuses on generating long-term capital appreciation and income through high-potential Indian real estate. The strategy emphasizes location advantage, developer strength, and value creation by investing in residential projects, commercial developments, and land-backed structured opportunities.
                            </p>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Real estate investments
                                </li>
                                <li className="flex items-center gap-2:">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Property <br /> Alpha Growth</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for investors seeking capital appreciation through high-quality property projects.</p>
                            <div className="space-y-3">
