...
export default function ITIGrowthDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Consumer & Retail', 'Financial Services', 'Technology', 'Industrials', 'Others'],
        datasets: [
            {
                data: [30, 25, 20, 15, 10],
                backgroundColor: ['#1CADA3', '#2076C7', '#0E8A82', '#94A3B8', '#CBD5E1'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
    ...
    const stageData = {
        labels: ['Growth Capital', 'Expansion Stage', 'Pre-IPO'],
        datasets: [
            {
                label: 'Allocation %',
                data: [60, 30, 10],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Growth-focused private equity AIF that invests in scalable Indian businesses across emerging sectors with strong growth potential.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Growth / PE", icon: TrendingUp },
                        { label: "Return Type", value: "Capital appreciation", icon: Target }
                    ].map((item, i) => (
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                ITI Growth Opportunities Fund II follows a growth / private equity strategy, backing scalable Indian businesses with strong fundamentals and market positioning. The fund aims to generate long-term capital appreciation by investing in emerging sectors like consumer, technology, and financial services.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <BarChartIcon className="w-5 h-5 text-[#2076C7]" /> Investment Stage
                                </h4>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            Targeting high-growth companies with strong scalability potential.
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">ITI Growth Opp</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                Focused on growth equity investments and private equity strategies with sectoral research expertise.
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Bottom-up stock selection
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> In-depth sectoral research
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Strong due diligence process
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Active portfolio involvement
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Invest in Indian <br /> Growth Stories</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for growth-focused investors seeking scalable PE opportunities.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Growth-focused", value: "Capital Gains", icon: TrendingUp },
                            { label: "Long-term", value: "Patient Capital", icon: Clock },
                            { label: "PE Exposure", value: "Scalable Mid-cap", icon: Briefcase }
                        ].map((item, i) => (
