...
export default function WhiteWhaleSecondariesDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);

    // Investment Type Allocation Data
    const allocationData = {
        labels: ['Fund Secondaries', 'Direct Secondaries', 'Pre-IPO Deals'],
        datasets: [
            {
                data: [50, 30, 20],
    ...
    const stageData = {
        labels: ['Late Stage', 'Pre-IPO', 'Growth Stage'],
        datasets: [
            {
                label: 'Allocation %',
                data: [60, 25, 15],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            A specialized private equity secondaries AIF focused on acquiring existing stakes in mature portfolio companies and funds for attractive risk-adjusted returns.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Tenure", value: "2–4 Years", icon: Clock },
                        { label: "Theme", value: "PE Secondaries", icon: TrendingUp },
                        { label: "Return Type", value: "Capital Growth", icon: Target }
                    ].map((item, i) => (
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                White Whale Secondaries Fund focuses on generating attractive risk-adjusted returns by investing in seasoned assets with shorter holding periods and better visibility. The fund acquires existing stakes in mature portfolio companies and PE funds at attractive valuations, aiming for faster liquidity and lower risk compared to early-stage investing.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <PieChartIcon className="w-5 h-5 text-[#2076C7]" /> Allocation by Investment Type
                                </h4>
                                    ...
                                    {allocationData.labels.map((label, i) => (
                                        <div key={i} className="flex justify-between items-center text-sm">
                                            <div className="flex items-center gap-2">
                                                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: allocationData.datasets[0].backgroundColor[i] }} />
                                                <span className="font-medium text-gray-600">{label}</span>
                                            </div>
                                            <span className="font-bold text-gray-900">{allocationData.datasets[0].data[i]}%</span>
                                        </div>
                                    ))}
                                </div>
                            </section>
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <BarChartIcon className="w-5 h-5 text-[#1CADA3]" /> Investment Stage
                                </h4>
                                <div className="h-[250px] w-full">
                                    <Bar data={stageData} options={barOptions} />
                                </div>
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            "Strategic emphasis on late-stage and pre-IPO liquidity."
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">White Whale Advisors</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                "Established firm with deep expertise in PE secondaries and structured late-stage deals."
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> PE secondaries mastery
                                </li>
                                <li className="flex items-center gap-2:">
                                    <CheckCircle size={14} className="text-white/60" /> Late-stage specialization
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Discounted entry analysis
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Short-cycle liquidity focus
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Secondary <br /> Yield Mastery</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for investors seeking shorter duration private equity exposure with high visibility.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Short Duration", value: "Duration Seekers", icon: Clock },
                            { label: "PE Exposure", value: "Secondary Stakes", icon: Briefcase },
                            { label: "Risk-Adjusted", value: "Seasoned Assets", icon: ShieldCheck }
                        ].map((item, i) => (
