...
export default function InCredGrowthDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Growth-oriented private equity AIF focused on investing in scalable mid-market companies across India.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                InCred Growth Partners Fund II follows a growth / private equity strategy, backing high-quality businesses with scalable models and strong management teams across consumer, financial services, and technology-driven sectors. The fund aims to deliver long-term capital appreciation by backing businesses with strong growth visibility.
                            </p>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            "Targeting scalable businesses in their growth and expansion phase."
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                "A reputed alternative investment platform with expertise in private equity and institutional management."
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                ...
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Sector-focused analysis
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Strong due diligence
                                </li>
                                <li className="flex items-center gap-2">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Capitalize On <br /> Growth Companies</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for growth-focused investors seeking private equity exposure.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "PE Exposure", value: "Mid-market", icon: Briefcase }
                        ].map((item, i) => (
