...
export default function Quest4ValueTristarDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Financial Services', 'Industrials', 'Consumer', 'Technology', 'Others'],
        datasets: [
            {
                data: [30, 25, 20, 15, 10],
                backgroundColor: ['#2076C7', '#1CADA3', '#123E66', '#0E8A82', '#94A3B8'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
    ...
    const marketCapData = {
        labels: ['Small Cap', 'Mid Cap', 'Pre-IPO / Others'],
        datasets: [
            {
                label: 'Allocation %',
                data: [50, 35, 15],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Growth-oriented AIF focused on investing in high-quality listed and pre-IPO companies with strong earnings growth and sustainable competitive advantages.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Growth / Equity", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Quest4Value Tristar Fund follows a growth equity and public market strategy. The fund aims to generate long-term capital appreciation by identifying businesses with strong earnings growth and sustainable competitive advantages through a rigorous bottom-up stock selection process.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <BarChartIcon className="w-5 h-5 text-[#1CADA3]" /> Market Cap Allocation
                                </h4>
                                <div className="h-[250px] w-full">
                                    <Bar data={marketCapData} options={barOptions} />
                                </div>
                    ...
                    <div className="space-y-8">
                        {/* Fund Manager */}
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#123E66] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Quest4Value Investment</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                ...
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Focus on scalable businesses
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Long-term wealth creation
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Active portfolio management
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Invest in High-Growth <br /> Businesses</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for long-term investors seeking capital appreciation through public equity strategies.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Equity-focused", value: "Public Market", icon: Activity },
                            { label: "Long-term", value: "Growth Horizon", icon: Clock },
                            { label: "Return Seekers", value: "Market-linked", icon: TrendingUp }
                        ].map((item, i) => (
