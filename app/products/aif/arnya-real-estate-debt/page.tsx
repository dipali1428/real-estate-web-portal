...
export default function ArnyaRealEstateDebtDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tighter font-sans leading-[1.1] bg-gradient-to-r from-[#2076C7] via-[#1CADA3] to-[#2076C7] bg-clip-text text-transparent drop-shadow-sm">
                            Arnya Real Estate <br />
                            Fund – Debt
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Secured lending AIF designed for stable income and consistent yield through real estate backed debt.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Real Estate Credit", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Arnya Real Estate Fund – Debt aims to generate stable income through secured lending opportunities in the real estate sector. The fund invests in a diversified portfolio of real estate backed debt instruments, focusing on asset-backed safety, developer due diligence, and conservative leverage.
                            </p>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Arnya Real Estate Advisors</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <div className="bg-white/10 p-2 rounded-lg text-[10px] font-bold text-center">Structured Credit</div>
                            </div>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Stable <br /> Income Yield</h4>
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Income-focused", icon: IndianRupee, value: "Regular Yield" },
                            { label: "RE Exposure", icon: Briefcase, value: "Diversification" },
                            { label: "Conservative", icon: ShieldCheck, value: "Asset-Backed" }
                        ].map((item, i) => (
