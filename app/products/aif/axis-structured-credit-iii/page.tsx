...
export default function AxisStructuredCreditDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Corporate Credit', 'Real Estate / Infra', 'Structured Deals', 'Others'],
        datasets: [
            {
                data: [40, 30, 20, 10],
    ...
    const instrumentData = {
        labels: ['Secured Debt', 'Structured Credit', 'Special Situations'],
        datasets: [
            {
                label: 'Allocation %',
                data: [60, 25, 15],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Private credit-focused fund targeting high-yield structured lending opportunities in India’s mid-market segment.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Tenure", value: "4–5 Years", icon: Clock },
                        { label: "Theme", value: "Structured Credit", icon: TrendingUp },
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Axis Structured Credit AIF – III targets high-yield structured lending opportunities in India’s underserved mid-market segment, aiming for stable income with downside protection through secured transactions. The strategy builds on previous funds that created diversified portfolios of structured credit deals.
                            </p>
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                ...
                                <div className="h-[250px] relative mb-8">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                        ...
                                        <span className="text-[10px] text-gray-400 font-bold uppercase">Credit Mix</span>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-teal-50 rounded-2xl border border-teal-100">
                                        <p className="text-xs text-teal-800 font-medium italic">
                                            "Focus on collateral-backed lending and predictable cash flows for downside protection."
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Axis Asset Management Company</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                "A leading AMC with a strong presence in private credit, fixed income, and alternative investments."
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Detailed credit underwriting
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Diversified portfolio construction
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Conservative exposure limits
                                </li>
                                <li className="flex items-center gap-2">
                        ...
                        {/* Fee Structure */}
                        <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                            <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">Indicative Fee Structure</h4>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Access High-Yield <br /> Private Credit</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for income-focused investors and portfolio diversifiers.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Income-focused", value: "Regular Yield", icon: IndianRupee },
                            { label: "Credit Investors", value: "Alternative Debt", icon: ShieldCheck },
                            { label: "Diversifiers", value: "Low Correlation", icon: TrendingUp }
                        ].map((item, i) => (
