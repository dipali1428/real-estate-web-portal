...
export default function RMSGrowthDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        ...
        datasets: [
            {
                data: [30, 25, 20, 15, 10],
                backgroundColor: ['#1CADA3', '#2076C7', '#123E66', '#0E8A82', '#94A3B8'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Growth-oriented private equity AIF focused on investing in scalable Indian businesses across emerging sectors with strong fundamentals and expansion potential.
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                RMS Growth Fund – Scheme 1 follows a growth and private equity strategy, targeting scalable Indian businesses across emerging sectors. The fund aims to deliver long-term capital appreciation by backing companies with strong fundamentals, expansion potential, and exceptional management teams.
                            </p>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">RMS Growth LLP</p>
                                </div>
                            </div>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Secure Growth <br /> Exposure</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for long-term investors seeking capital appreciation through private equity.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Growth-focused", value: "Capital Appr.", icon: Activity },
                            { label: "Long-term", value: "Strategic Horizon", icon: Clock },
                            { label: "PE Seekers", value: "Market Exposure", icon: TrendingUp }
                        ].map((item, i) => (
