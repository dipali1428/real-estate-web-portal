...
export default function SundaramPCOFDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        ...
        datasets: [
            {
                data: [50, 25, 15, 10],
                backgroundColor: ['#1CADA3', '#2076C7', '#123E66', '#CBD5E1'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
    ...
    const instrumentData = {
        labels: ['Performing Debt', 'Structured Credit', 'Cash / Liquid'],
        datasets: [
            {
                label: 'Allocation %',
                data: [65, 25, 10],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            A credit-focused AIF investing in performing corporate credit opportunities to generate stable and predictable income with capital preservation.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        ...
                        { label: "Theme", value: "Perf. Credit", icon: TrendingUp },
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Sundaram PERFORMING CREDIT OPPORTUNITIES FUND (PCOF) – Sr I follows a performing credit strategy. The fund invests in high-quality corporate debt and structured credit opportunities, focusing on borrowers with strong repayment capacity and predictable cash flows to ensure consistent accrual returns.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <section className="bg-white rounded-[3rem] p-8 shadow-xl border border-gray-100">
                                <h4 className="font-bold text-gray-700 mb-8 flex items-center gap-2">
                                    <BarChartIcon className="w-5 h-5 text-[#2076C7]" /> Instrument Allocation
                                </h4>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-teal-50 rounded-2xl border border-teal-100">
                                        <p className="text-xs text-teal-800 font-medium italic">
                                            "Yield-focused allocation across performing debt instruments."
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                "Established expertise in credit strategies and active monitoring."
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Performing asset focus
                                </li>
                                <li className="flex items-center gap-2:">
                                    <CheckCircle size={14} className="text-white/60" /> Strong credit underwriting
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Diversified exposure
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Accrual-income strategy
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Stable <br /> Yield Income</h4>
                            <p className="text-slate-400 text-sm mb-8 font-medium">Ideal for investors seeking predictable accrual income through corporate credit.</p>
                            <div className="space-y-3">
                ...
                <section className="bg-white rounded-[4rem] p-12 lg:p-20 shadow-xl border border-gray-100 text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 relative z-10">
                        {[
                            ...
                            { label: "Diversification", value: "Fixed Income", icon: TrendingUp }
                        ].map((item, i) => (
