...
export default function GrowthcapVenturesDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const sectorData = {
        labels: ['Consumer & Retail', 'Technology', 'Financial Services', 'Industrials', 'Others'],
        datasets: [
            {
                data: [30, 25, 20, 15, 10],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tighter font-sans leading-[1.1] bg-gradient-to-r from-[#1CADA3] via-[#2076C7] to-[#1CADA3] bg-clip-text text-transparent drop-shadow-sm">
                            Growthcap Ventures <br />
                            Fund I
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Growth-oriented Category II AIF focused on investing in scalable Indian businesses with strong expansion potential.
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section className="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-10">
                                Growthcap Ventures Fund I follows a growth / private equity strategy, backing companies in their growth and expansion phases across consumer and technology-driven sectors. The fund aims to deliver long-term capital appreciation by backing scalable Indian businesses with strong expansion potential.
                            </p>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                        <p className="text-xs text-blue-800 font-medium italic">
                                            A growth-focused approach targeting mid-market leaders in their expansion phase.
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-gradient-to-br from-[#1CADA3] to-[#2076C7] rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-xs font-bold uppercase tracking-widest mt-1">Growthcap Ventures</p>
                                </div>
                            </div>
                            <p className="text-white/90 text-sm leading-relaxed mb-6 font-medium italic">
                                Focused on mid-market expansion stories with a bottom-up company selection and active management.
                            </p>
                            <ul className="space-y-2 text-xs font-bold font-sans">
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Bottom-up selection
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Sectoral growth analysis
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Scalable identification
                                </li>
                                <li className="flex items-center gap-2">
                                    <CheckCircle size={14} className="text-white/60" /> Active management
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl">
                            <h4 className="text-2xl font-black mb-4 leading-tight">Back Scalable <br /> Growth Stories</h4>
