...
export default function VehicleLoanPartners() {
    ...
    const [showAll, setShowAll] = useState(true); // Default to show all for 10 items is reasonable
                                ...
                                >
                                    {visiblePartners.map((partner) => {
                                        return (
                                            ...
                                            >
                                                <div
                                                    className={`w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition bg-teal-50 text-teal-500`}
                                                >
