...
import Hero from '../NCD/components/Hero';
import WhyInvest from '../NCD/components/WhyInvest';
import Offers from '../NCD/components/Offers';
import Comparison from '../NCD/components/Comparison';
import InvestmentUniverse from '../NCD/components/InvestmentUniverse';
import Eligibility from '../NCD/components/Eligibility';
import TaxBenefits from '../NCD/components/TaxBenefits';
import Risks from '../NCD/components/Risks';
import Portfolio from '../NCD/components/Portfolio';
import FAQ from '../NCD/components/FAQ';
import HowItWorks from '../NCD/components/HowItWorks';
import NCDYieldChart from '../NCD/components/NCDYieldChart';
import Disclaimer from '../NCD/components/Disclaimer';
