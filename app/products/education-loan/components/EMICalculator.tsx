...
export default function EMICalculator({ onApplyClick, hidePartners = false }: { onApplyClick: () => void, hidePartners?: boolean }) {
    ...
    return (
        <section className="pt-0 pb-4 md:pb-8 bg-white">
