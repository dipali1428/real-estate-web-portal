...
export default function PGIMPhoenixDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const calendarData = {
        ...
        datasets: [
            {
                label: 'Returns',
                data: [43.38, 17.69, -13.19],
                backgroundColor: (context: any) => {
                    const value = context.dataset.data[context.dataIndex];
                    return value < 0 ? '#EF4444' : (context.dataIndex % 2 === 0 ? '#2076C7' : '#1CADA3');
                },
                borderRadius: 4,
                barThickness: 32,
            }
    ...
    const allocationData = {
        labels: ['Small Cap', 'Mid Cap', 'Cash'],
        datasets: [
            {
                data: [91, 5, 4],
                backgroundColor: ['#1CADA3', '#2076C7', '#94A3B8'],
                borderWidth: 0,
                hoverOffset: 10,
            }
        ]
    ...
    const sectorData = [
        ...
        { name: 'Materials', value: 9.19 },
        { name: 'Consumer Staples', value: 3.98 },
        { name: 'Communication Services', value: 3.68 },
        { name: 'Real Estate', value: 3.04 },
    ...
    const holdings = [
        ...
        { name: 'Sansera Engineering Ltd', weight: '4.35%' },
        { name: 'Sai Life Sciences Ltd', weight: '4.32%' },
        { name: 'Karnataka Bank Ltd', weight: '4.23%' },
        { name: 'Gillette India Ltd', weight: '3.98%' },
        { name: 'Paushak Ltd', weight: '3.96%' },
    ];
        ...
        <div className="bg-neutral-50 font-sans text-gray-700">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        { label: 'Inception', value: '01 Aug 2016', icon: Calendar },
                        { label: 'Manager', value: 'Mohit Khanna', icon: UserCheck },
                        { label: 'AUM', value: '₹56.91 Cr', icon: BarChart3 },
                        { label: 'Benchmark', value: 'NIFTY Smallcap 250', icon: Target },
                    ...
                    <div className="lg:col-span-2 bg-white rounded-[2.5rem] p-8 shadow-xl border border-gray-100 relative overflow-hidden group">
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
                                ...
                                <div className="text-2xl font-black text-primary">35.86%</div>
                                <div className="text-xs text-slate-400 mt-1">Growth</div>
                            </div>
                            <div className="bg-neutral-50 rounded-2xl p-4 border border-gray-100">
                                <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">FY 2025 YTD</div>
                                <div className="text-2xl font-black text-slate-700">-1.05%</div>
                            ...
                            <div className="bg-neutral-50 rounded-2xl p-4 border border-gray-100 flex items-center justify-center text-center">
                                <p className="text-sm text-slate-600 italic font-medium">
                                    "Navigated multiple market cycles with a disciplined small-cap strategy."
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-xl border border-gray-100">
                        ...
                        <div className="h-[250px] w-full relative">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                <span className="text-3xl font-black text-gray-700">91%</span>
                    ...
                    <div className="lg:col-span-2 bg-white rounded-[2.5rem] p-8 shadow-xl border border-gray-100">
                        ...
                        <div className="mb-6 bg-blue-50/50 p-4 rounded-xl border border-blue-100 text-sm text-slate-600 italic">
                            High conviction bets in Industrials, Consumer, and Financials.
                        </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-16">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 lg:p-12 shadow-xl border border-gray-100 relative overflow-hidden">
                        ...
                        <div className="space-y-6 relative z-10">
                            {[
                                "Focus on quality mid and small-cap businesses",
                                "Bottom-up stock selection with strong fundamentals",
                                "Emphasis on earnings growth, balance-sheet strength and governance",
                                "Long-term investment horizon with disciplined risk management",
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-xl border border-gray-100">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                { l: "Weighted Avg RoCE", v: "18.20%", sub: "(ex-financials)" },
                                { l: "Portfolio P/E", v: "23.34", sub: "(FY27E)" },
                                { l: "Sharpe Ratio", v: "0.47", sub: "" },
                                { l: "Standard Deviation", v: "16.81%", sub: "" },
                                { l: "Beta", v: "0.94", sub: "" },
                                { l: "Jensen Alpha", v: "0.58", sub: "" },
                                { l: "Top 10 Concentration", v: "43.86%", sub: "" },
                            ].map((attr, i) => (
                ...
                <div className="mt-16 text-center">
                    <div className="flex flex-col md:flex-row gap-6 justify-center">
                        <a href="/assets/factsheets/PGIM India Phoenix Portfolio - Factsheet December 2025.pdf" target="_blank" rel="noopener noreferrer" className="bg-[#2076C7] hover:bg-[#185ea0] text-white px-10 py-5 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all flex items-center justify-center gap-3">
                            <Download size={20} />
                            Download Factsheet
                        </a>
