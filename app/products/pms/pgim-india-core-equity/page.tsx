...
export default function PGIMCoreEquityDetail() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const calendarData = {
        ...
        datasets: [
            {
                label: 'Returns',
                data: [35.22, 10.37, 23.37, 15.65, -3.60],
    ...
    // 4. Sector Allocation
    const sectorData = [
        { name: 'Financials', value: 20.92 },
        { name: 'Consumer Discretionary', value: 15.10 },
        { name: 'Materials', value: 14.02 },
        { name: 'Health Care', value: 13.04 },
        { name: 'Industrials', value: 11.02 },
        { name: 'Information Technology', value: 8.22 },
        { name: 'Energy', value: 5.77 },
        { name: 'Real Estate', value: 4.38 },
        { name: 'Consumer Staples', value: 3.92 },
    ];

    // 5. Top Holdings
    const holdings = [
        { name: 'Shriram Finance Ltd', weight: '5.88%' },
        { name: 'Reliance Industries Ltd', weight: '5.77%' },
        { name: 'Axis Bank Ltd', weight: '5.27%' },
        { name: 'HDFC Life Insurance Co Ltd', weight: '5.16%' },
        { name: 'UltraTech Cement Ltd', weight: '4.70%' },
        { name: 'Divi’s Laboratories Ltd', weight: '4.66%' },
        { name: 'Bajaj Finance Ltd', weight: '4.61%' },
        { name: 'KEI Industries Ltd', weight: '4.56%' },
        { name: 'The Phoenix Mills Ltd', weight: '4.38%' },
        { name: 'Tech Mahindra Ltd', weight: '4.25%' },
    ];
        ...
        <div className="bg-neutral-50 font-sans text-gray-700">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20 pb-24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    {[
                        { label: 'Inception', value: '08 Jul 2013', icon: Calendar },
                        { label: 'Manager', value: 'Mohit Khanna', icon: UserCheck },
                        { label: 'AUM', value: '₹119.15 Cr', icon: BarChart3 },
                        { label: 'Benchmark', value: 'NIFTY 50 TRI', icon: Target },
                        { label: 'Strategy', value: 'Core / Multi-Cap', icon: PieChart },
                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-16">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 lg:p-12 shadow-xl border border-gray-100 relative overflow-hidden">
                        ...
                        <div className="space-y-6 relative z-10">
                            {[
                                "Focus on high-quality companies with strong competitive advantages",
                                "Valuation discipline: quality at reasonable price",
                                "Bottom-up stock selection across sectors",
                                "Long-term investment horizon with risk-aware portfolio construction"
                            ].map((point, i) => (
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-xl border border-gray-100">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                { l: "Weighted Avg RoCE", v: "21.04%", sub: "(ex-financials)" },
                                { l: "Portfolio P/E", v: "33.91", sub: "(FY27E)" },
                                { l: "Sharpe Ratio", v: "0.41", sub: "" },
                                { l: "Standard Deviation", v: "12.76%", sub: "" },
                                { l: "Beta", v: "0.88", sub: "" },
                                { l: "Jensen Alpha", v: "-1.61", sub: "" },
