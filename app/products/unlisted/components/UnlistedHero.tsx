...
// Define Enquiry type matching the backend API
...
export default function UnlistedHero({ onActionClick, onApplyClick }: UnlistedHeroProps) {
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Using CustomerService.submitEnquiry (should use /api/customer/enquiries)
                ...
                <div className="fixed inset-0 z-[7000] bg-black/60 flex items-center justify-center p-4">
                    <div className="bg-white p-8 rounded-2xl max-w-md w-full text-center shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <p className="text-gray-500 text-sm mb-4 leading-relaxed">
                            Thank you for your interest in <span className="font-semibold text-[#2076C7]">{formData.product_name || 'unlisted shares'}</span>!<br />
