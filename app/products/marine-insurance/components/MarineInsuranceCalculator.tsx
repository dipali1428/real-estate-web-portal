        ...
        <div className="w-full max-w-6xl mx-auto font-sans">
                        ...
                        <div className="h-full flex flex-col justify-center">
                            {!isCalculated ? (
                                <div className="bg-gray-50/50 rounded-2xl p-10 py-16 border border-gray-100 border-dashed text-center space-y-4">
                                    <div className="w-16 h-16 bg-[#2076C7]/5 rounded-full flex items-center justify-center mx-auto text-[#2076C7]/40">
                                        <Shield size={32} />
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-xl shadow-sm border-l-4 border-blue-700">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center gap-3 p-3 bg-[#2076C7]/5 rounded-lg border border-[#2076C7]/10">
                                                <AlertCircle className="text-[#2076C7] shrink-0" size={16} />
                                                <p className="text-[9px] text-[#2076C7] font-bold leading-relaxed uppercase tracking-wider">
            ...
            <div className="mt-8 p-6 bg-gray-50/50 rounded-2xl border border-gray-100 border-dashed">
                <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[#1CADA3]/10 flex items-center justify-center text-[#1CADA3] shrink-0">
                        <Info size={20} />
                    </div>
                    <div>
                        <h4 className="text-xs font-bold text-[#2076C7] uppercase tracking-widest mb-2">Disclaimer: Marine Insurance Premium Estimator</h4>
                        <p className="text-[10px] text-[#1CADA3] font-bold leading-relaxed uppercase tracking-wider">
