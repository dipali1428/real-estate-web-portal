                            ...
                            {partnerBanks.map((bank, idx) => (
                                ...
                                >
                                    ...
                                    <div className="overflow-hidden">
                                        <h4 className="font-black text-gray-800 text-xs md:text-sm uppercase tracking-tight truncate">
                                            {bank.name}
                                        </h4>
                        ...
                        <div className="max-w-2xl mx-auto animate-in slide-in-from-right duration-300">
                            <div className="bg-white rounded-[2rem] border border-gray-100 p-8 md:p-10 shadow-lg">
                                <div className="flex items-center gap-5 mb-8">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-black text-gray-900 group-hover:text-[#2076C7] transition-colors">{selectedBank.name}</h3>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <button
                                        ...
                                        className="flex-1 bg-gradient-to-r from-[#2076C7] to-[#1CADA3] text-white py-4 rounded-xl font-black text-lg shadow-xl shadow-teal-500/20 hover:shadow-teal-500/40 hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
                                    >
                                        Proceed with {selectedBank.name.split(' ')[0]} <ArrowRight size={22} />
                                    </button>
                                    <button
