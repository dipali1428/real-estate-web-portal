    ...
    return (
        <section className="py-12 md:py-20 bg-white font-sans" style={{ fontFamily: 'var(--font-geist-sans)' }}>
            <div className="container mx-auto px-4 md:px-6 max-w-7xl">
                <div className="relative overflow-hidden bg-linear-to-r from-[#2076C7] to-[#1CADA3] rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-16 text-center text-white shadow-2xl">
                    {/* Decorative Elements */}
