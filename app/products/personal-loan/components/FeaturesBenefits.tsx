            ...
            <div className="container mx-auto px-4 md:px-6 max-w-7xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8 mb-10 md:mb-12">
                    {features.map((item, idx) => (
                        <div
                            key={idx}
                            className="group relative p-6 md:p-8 bg-white rounded-2xl md:rounded-3xl border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col items-center text-center"
                        >
                            ...
                            <div className="relative z-10 w-full flex flex-col items-center">
                                <div className="w-11 h-11 md:w-14 md:h-14 bg-gradient-to-br from-[#2076C7] to-[#1CADA3] rounded-xl md:rounded-2xl flex items-center justify-center text-white mb-5 md:mb-6 shadow-lg shadow-blue-100 mx-auto">
