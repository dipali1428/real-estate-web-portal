...
import TicketCard from '../supportticket/ticketcard';
import AdminTicketStats from '../supportticket/ticketstats';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
          ...
          <div className="divide-y divide-gray-200">
            {currentPageTickets.map(ticket => (
              <TicketCard key={ticket._id} ticket={ticket} onStatusUpdate={handleStatusUpdate} />
            ))}
          </div>
