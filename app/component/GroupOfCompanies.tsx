  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
          ...
          <div className="border border-gray-100 rounded-xl p-5 bg-white shadow-md hover:shadow-xl hover:border-[#1CADA3]/30 transition-all duration-500 min-h-[240px] group relative overflow-hidden">
            ...
            <div className="space-y-2 text-sm">
              <div>
                ...
                <span className="font-semibold text-black">ACP-0126</span>
              </div>
              ...
              <div>
                ...
                <span className="font-semibold text-black">347839</span>
              </div>
            </div>
        ...
        {/* Second Row - 2 New Companies (centered with auto-fit) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mt-6 max-w-3xl mx-auto">
          {/* FINANCE - New Company 1 */}
          <div className="border border-gray-100 rounded-xl p-5 bg-white shadow-md hover:shadow-xl hover:border-[#1CADA3]/30 transition-all duration-500 min-h-[240px] group relative overflow-hidden">
            <div className="font-bold text-base bg-gradient-to-r from-[#2076C7] to-[#1CADA3] bg-clip-text text-transparent mb-3">
              FINANCE
            </div>
