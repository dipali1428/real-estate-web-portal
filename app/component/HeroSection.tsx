        ...
        <section id='home' className="relative bg-white overflow-hidden">
            ...
            <div className="relative container mx-auto px-4 py-15 md:py-25 mb-5">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    {/* Main heading */}
                    <h1
                        className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 min-h-16 md:min-h-20 leading-tight"
                        style={{
                    ...
                    {/* Subtitle */}
                    <p
                        className={`text-lg md:text-xl lg:text-2xl mb-10 text-gray-700 leading-relaxed transition-opacity duration-1000 ${
                    ...
                    {/* Buttons */}
                    <div
                        className={`flex flex-col sm:flex-row justify-center gap-4 transition-opacity duration-1000 delay-300 ${
                            isTypingComplete ? 'opacity-100' : 'opacity-0'
                        }`}
                    >
                        <a href='#services'>
                    ...
                    {/* Trust indicators */}
                    <div
                        className={`mt-16 flex flex-wrap justify-center items-center gap-8 text-gray-600 transition-opacity duration-1000 delay-500 ${
                            isTypingComplete ? 'opacity-100' : 'opacity-0'
                        }`}
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">3200+ Active DSA Partners</span>
                        </div>
