            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="mb-6">
                  <div className="flex justify-between mb-3">
                    ...
                    <span className="font-bold text-teal-500">{formatCurrency(sipAmount)}</span>
                  </div>
                  <input
                    type="range"
                    min="500"
                ...
                <div className="mb-6">
                  <div className="flex justify-between mb-3">
                    ...
                    <span className="font-bold text-teal-500">{sipDuration} Years</span>
                  </div>
                  <input
                    type="range"
                    min="1"
                ...
                <div className="mb-6">
                  <div className="flex justify-between mb-3">
                    ...
                    <span className="font-bold text-teal-500">{sipReturn}%</span>
                  </div>
                  <input
                    type="range"
                    min="1"
              ...
              <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-2xl p-6 shadow-lg">
                ...
                <div className="flex justify-between items-center mb-5 pb-4 border-b border-teal-400">
                  ...
                  <span className="text-xl font-bold">{formatCurrency(sipResults.totalInvestment)}</span>
                </div>

                <div className="flex justify-between items-center mb-5 pb-4 border-b border-teal-400">
                  <span className="text-lg">Est. Returns</span>
                  <span className="text-xl font-bold">{formatCurrency(sipResults.estimatedReturns)}</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-lg">Total Value</span>
                  <span className="text-xl font-bold">{formatCurrency(sipResults.totalValue)}</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="animate-fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-2xl p-6 shadow-lg">
                ...
                <div className="flex justify-between items-center mb-5 pb-4 border-b border-teal-400">
                  <span className="text-lg">Total Investment</span>
                  <span className="text-xl font-bold">{formatCurrency(lumpsumResults.totalInvestment)}</span>
                </div>

                <div className="flex justify-between items-center mb-5 pb-4 border-b border-teal-400">
                  <span className="text-lg">Est. Returns</span>
                  <span className="text-xl font-bold">{formatCurrency(lumpsumResults.estimatedReturns)}</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-lg">Total Value</span>
                  <span className="text-xl font-bold">{formatCurrency(lumpsumResults.totalValue)}</span>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mt-8">
          ...
          <div className="flex items-end justify-center gap-16 py-6">
            ...
            <div className="flex flex-col items-center">
              ...
              >
                <div className="absolute -top-8 left-0 w-full text-center font-bold text-gray-800 text-lg">
