...
const ContactPage = () => {
  ...
  const groupedContacts = Object.values(
    contacts.reduce((acc: Record<string, GroupedContact>, item) => {
      if (!acc[item.name]) {
        acc[item.name] = {
          name: item.name,
        ...
        acc[item.name].products.push(item.product);
      }
      return acc;
    }, {})
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* UPDATED GRID USING groupedContacts */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {groupedContacts.map((contact, index) => (
            <div
              ...
              {/* Product Badge (multiple products merged) */}
              <div className="mb-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-900 font-medium">{contact.contactNo}</span>
                </div>
              </div>

              {/* Buttons unchanged */}
              <div className="mt-6 flex space-x-3">
                <button className="flex-1 bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2 text-sm font-medium">
                ...
                <button className="flex-1 bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2 text-sm font-medium">
        ...
        <div className="mt-12 text-center">
          <div className="bg-blue-50 rounded-lg p-6 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600">
              Our representatives are available during business hours. Feel free to call or message them directly.
            </p>
          </div>
        </div>
