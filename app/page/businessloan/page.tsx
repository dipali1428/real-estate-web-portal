    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#2076C7] to-[#1CADA3] text-white py-4 sm:py-6 px-4 sm:px-8 text-center">
        <div className="flex items-center justify-center gap-2 sm:gap-3 mb-1 sm:mb-2">
          <i className="fas fa-building text-white text-xl sm:text-2xl"></i>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">Business Loan Calculator</h1>
        </div>
        <p className="text-blue-100 text-sm sm:text-base px-2">Plan your business expansion with our business loan calculator</p>
      </div>
