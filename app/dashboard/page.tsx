            ...
            <section className="animate-fade-in">
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="relative group">
                            <div className="absolute right-0 top-full mt-2 w-64 sm:w-80 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                                <div className="p-4">
                                    <h5 className="font-semibold text-gray-800 mb-3 text-base sm:text-lg">Notifications</h5>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="mt-4">
                            <div className="text-xl sm:text-2xl font-bold font-sans text-gray-800">0</div>
                            <div className="text-gray-600 mt-1 text-sm sm:text-base">Total Business Volume</div>
                            <div className="flex items-center text-green-500 text-xs sm:text-sm mt-2">
                        ...
                        <div className="space-y-4">
                            <div className="pb-3 border-b border-gray-100">
                                <div className="flex items-start">
                                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-500 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="pb-3 border-b border-gray-100">
                                <div className="flex items-start">
                                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="pb-3 border-b border-gray-100">
                                <div className="flex items-start">
                                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-purple-500 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                <div className="flex items-start">
                                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-500 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
