                  ...
                  <div
                    ...
                    <div className="space-y-2 grow min-w-0">
                      ...
                      <div className="text-xs text-gray-600 leading-tight min-w-0">
                        ...
                        <span className="text-gray-800 ml-1 wrap-break-word whitespace-normal min-w-0">
                      ...
                      <div className="block md:hidden p-3 sm:p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center space-x-2 sm:space-x-3">
                            <div className={`p-1.5 sm:p-2 rounded-lg ${getTypeStyles(appointment.type)} shrink-0`}>
                      ...
                      <div className="hidden md:block lg:hidden p-4">
                        <div className="flex items-start justify-between">
                          <div className="flex items-start space-x-3 sm:space-x-4 flex-1">
                            <div className={`p-2 sm:p-3 rounded-lg shrink-0 ${getTypeStyles(appointment.type)}`}>
                              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                              </svg>
                            </div>
                          ...
                          <div className="flex flex-col space-y-1.5 sm:space-y-2 ml-3 sm:ml-4 shrink-0">
                            <button
                              onClick={() => handleRescheduleAppointment(appointment.id)}
