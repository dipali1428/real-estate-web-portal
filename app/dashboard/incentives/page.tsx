...
export default function IncentivesPayouts() {
  ...
  const commissionStructure = {
    'loans': [{ name: 'Personal Loan', rate: '1.60% - 2.85%' }, { name: 'Home Loan', rate: '0.4% - 0.88%' }, { name: 'Business Loan', rate: '1.05% - 3.33%' }, { name: 'Commercial / Mortgage', rate: '0.50% - 1%' }, { name: 'SME Loan', rate: '1.2% - 2.0%' }, { name: 'Education Loan', rate: '0.40% - 0.96%' }, { name: 'Vehicle Loan', rate: '0.64% - 1.40%' }, { name: 'NRP / LAP Loan', rate: '0.5% - 1%' }, { name: 'Loan Against Securities', rate: '0.5% - 1.2%' }],
    'insurance': [{ name: 'Life Insurance', rate: '50% - 80%' }, { name: 'Health Insurance', rate: '50% - 80%' }, { name: 'Motor Insurance', rate: '4% - 50%' }, { name: 'Travel Insurance', rate: '50% - 80%' }, { name: 'Fire Insurance', rate: '50% - 80%' }, { name: 'Cattle Insurance', rate: '50% - 80%' }, { name: 'Marine Insurance', rate: '50% - 80%' }, { name: 'Corporate Insurance', rate: '50% - 80%' }, { name: 'Loan Protector', rate: '50% - 80%' }],
    ...
    'real-estate': [{ name: 'Fractional Real Estate', rate: '15% - 20%' }]
  };
  ...
  const calculation = useMemo(() => {
    ...
    if (leadCategory === 'loans') {
      grossAmount = receivableAmount * 0.005; // 0.5% of receivable
      percentLabel = "0.5%";
    } else if (leadCategory === 'insurance') {
      grossAmount = receivableAmount * 0.005; // 50% of premium
      percentLabel = "50%";
    } else if (leadCategory === 'mutual-funds') {
      grossAmount = receivableAmount * 0.005; // 0.6% of receivable
      percentLabel = "0.6%";
    } else if (leadCategory === 'investments') {
      grossAmount = receivableAmount * 0.005; // 1.5% of receivable
      percentLabel = "1.5%";
    } else if (leadCategory === 'real-estate') {
      grossAmount = receivableAmount * 0.005; // 1.75% of receivable
      percentLabel = "1.75%";
    }
