...
export default function PersonalLoanForm({ onClose }: PersonalLoanFormProps) {
  ...
  const validateForm = useCallback((): boolean => {
    ...
    if (!form.deductionDetails.trim()) newErrors.deductionDetails = "Deduction details are required";
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <Field 
              ...
              onChange={(v) => handleInputChange("deductionDetails", v)} 
