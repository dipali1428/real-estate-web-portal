...
const DOC_MAP: Record<string, string[]> = {
  "Salaried Person": [
    ...
    "6 Months Bank Statement", "Company ID Card", "Address Proof", "Photograph", 
    "Existing Loan Statement", "Property Cost Sheet / Index II", "Own Contribution Proof"
  ],
  "Self Employed": [
    "Aadhar Card", "PAN Card", "Udyam Registration", "Shop Act Licence", 
    "GST Certificate", "Last 12 Months GST Returns", "3 Years ITR", 
    "6 Months Bank Statement", "Saving Bank Account", "Business Office Address Proof", 
    "Address Proof", "Photograph", "Existing Loan Statement", 
    "Property Cost Sheet / Index II", "Own Contribution Proof"
  ],
  "Pensioner": [
    "Aadhar Card", "PAN Card", "PPO (Pension Payment Order)", "1 Year Pension Credit Statement"
  ],
  "Rental": [
    "Rent Agreement", "1 Year Rent Credit Statement"
  ],
};
...
export default function NrpLoanForm({ onClose }: NrpLoanFormProps) {
  ...
  const validateForm = useCallback((): boolean => {
    ...
    // NRP Specific
    if (!form.loanCategory) newErrors.loanCategory = "Select loan category";
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            />
             ...
             <Field 
              ...
              onChange={(v) => handleInputChange("loanCategory", v)} 
              options={["Fresh", "Resell", "BT"]} 
